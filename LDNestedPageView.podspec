...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LDNestedPageView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/李东/LDNestedPageView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '李东' => 'Black_leedong@163.com' }
  s.source           = { :git => 'https://github.com/李东/LDNestedPageView.git', :tag => s.version.to_s }
